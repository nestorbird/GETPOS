...
#firsssssssssssssttttttttttttttttttt veeeeeeeeeeeeeerrrrrrrsssssssiiiiiiiiiioooooooooonnnnnnnnnnnn
...
#Secooooooooooooooonddddddddddddd versssssssssssssiiiiiiiiiiooooooooooooonnnnnnnnnnnnnnnnnnnnnnn
...
#         # Exclude empty item groups when item_code filter is applied individually
#         if not item_order_by and item_code:
#             if group_dict['items']:
#                 data.append(group_dict)
#         elif not item_order_by:
#             data.append(group_dict)
