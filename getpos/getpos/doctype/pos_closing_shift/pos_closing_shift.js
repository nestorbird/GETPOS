...
frappe.ui.form.on('POS Closing Shift', {
	onload: function (frm) {
		...
		frm.set_query("user", function (doc) {
			return {
				query: "getpos.getpos.doctype.pos_closing_shift.pos_closing_shift.get_cashiers",
	...
	get_pos_invoices(frm) {
		frappe.call({
			method: 'getpos.getpos.doctype.pos_closing_shift.pos_closing_shift.get_pos_invoices',
			args: {
