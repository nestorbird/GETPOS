...
const OrderBox = ({ order, showPayNow, showDelete, showMoveToCart, onClick, onDelete,indicator, currency }) => {
 ...
 <span className='amountAndDate'>
    <span className="light-text">{(currency || "$")} {order.total ? (order.total).toFixed(2) : '0.00'} <span className="order-date">| {formattedDate}
